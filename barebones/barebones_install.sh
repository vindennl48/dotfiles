...
curl https://raw.githubusercontent.com/vindennl48/dotfiles/master/barebones/barebones_bash.alias -o ~/.bashrc2
echo "source ~/.bashrc2" >> ~/.bashrc

echo "----> Installing Vim aliases.."
curl https://raw.githubusercontent.com/vindennl48/dotfiles/master/barebones/barebones_vim.vim -o ~/.vimrc2
